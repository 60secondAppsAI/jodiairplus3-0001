    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'passengerName',
          ...
          sorter: true
          //sorter: (a, b) => a.passengerName - b.passengerName,
		...
		dataIndex: 'passengerEmail',
          visible: true,
          scopedSlots: { customRender: 'passengerEmail' },
          sorter: true
          //sorter: (a, b) => a.passengerEmail - b.passengerEmail,
          //sorter: (a, b) => a.passengerEmail.localeCompare(b.passengerEmail),
        },
        {
          title: 'Fare',
		dataIndex: 'fare',
          ...
          //sorter: (a, b) => a.fare.localeCompare(b.fare),
        },
      ],
      pagination: {
        current: 1,
